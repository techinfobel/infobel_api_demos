"""Example script that authenticates and queries the Infobel BizSearch API."""
...
SEARCH_URL = "https://bizsearch.infobelpro.com/api/search"


class BizSearchApiError(RuntimeError):
    """Raised when a BizSearch API call fails."""
...
def main() -> int:
    ...
    try:
        token_response = get_infobel_token()
